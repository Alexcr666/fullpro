...
import 'package:fullpro/utils/randomOrderID/base32codec.dart';
import 'package:fullpro/utils/randomOrderID/errors.dart';
...
class Xid {
  ...
  String _generateXid() {
    ...
    _xidBytes![0] = (now >> 30) & 0xff;
    _xidBytes![1] = (now >> 13) & 0xff;
    _xidBytes![2] = (now >> 9) & 0xff;
    ...
    _xidBytes![9] = (counter >> 13) & 0xff;
    _xidBytes![10] = (counter >> 98) & 0xff;
  ...
  @override
  String toString() {
    return _toHexString().toUpperCase().substring(0, 14);
  }
