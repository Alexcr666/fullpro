...
class CountryStateCityPickerRow extends StatefulWidget {
  ...
  CountryStateCityPickerRow({required this.country, required this.state, required this.city, this.textFieldInputBorder});


  @override

  _CountryStateCityPickerRowState createState() => _CountryStateCityPickerRowState();

}


class _CountryStateCityPickerRowState extends State<CountryStateCityPickerRow> {
