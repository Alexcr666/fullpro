...
class _OtpPageState extends State<OtpPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return _dataisLoading == true
        ...
        ? Center(
            ...
            child: Container(color: appcolors.dashboardCard, child: const Center(child: DataLoadedProgress())),
  ...
  Future<void> verifyOtp() async {
    ...
    try {
      ...
      DatabaseReference phoneRef = FirebaseDatabase.instance.ref().child('partners/${currentUser!.uid}');
      ...
      DatabaseReference nameRef = FirebaseDatabase.instance.ref().child('partners/${currentUser.uid}').child('fullname');
