...
import 'package:fullpro/widgets/calender/date_widgt.dart';
...
class _DatePickerState extends State<DatePicker> with AutomaticKeepAliveClientMixin {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return DateWidget(
            ...
            //for color change
            selectionBorderColor: isSelected ? _static.themeColor[500]! : Color.fromARGB(255, 255, 255, 255),
            selectionColor: isSelected ? widget.selectionColor : Color.fromARGB(255, 255, 255, 255),
