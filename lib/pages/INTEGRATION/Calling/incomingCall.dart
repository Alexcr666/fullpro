                ...
                if (!snapshot.hasData) {
                  ...
                  try {
                    ...
                    if (snapshot.data!.docs[0]['response'] == 'Awaiting') {
                      ...
                      print('snapshot values are ${snapshot.data!.docs[0]['response']}');
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            ...
                            snapshot.data!.docs[0]['callType'] == "VideoCall"
                                ...
                                ? "Incoming Video Call".toString()

                                : "Incoming Audio Call".toString(),
                    ...
                    //    case "Pickup":
                      ...
                      print("call is picked up ${widget.callInfo['channel_id']} , callType ${snapshot.data!.docs[0]['callType']}");
                    ...
                    else if ((snapshot.data!.docs[0]['response'] == "Call_Cancelled"))
