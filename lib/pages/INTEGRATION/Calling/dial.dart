...
class DialCall extends StatefulWidget {
  ...
  const DialCall({required this.channelName, required this.receiver, required this.callType});
            ...
            if (!snapshot.hasData) {
              ...
              try {
                ...
                if ((snapshot.data!.docs[0]['response']) == 'Awaiting') {
                  ...
                  return Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Calling to ${widget.receiver.name}", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                      ...
                      ElevatedButton.icon(
                          ...
                          onPressed: () async {
                            ...
                            await callRef.doc(widget.channelName).set({'response': "Call_Cancelled"}, SetOptions(merge: true));
                ...
                //     break;
                  ...
                  return CallPage(channelName: widget.channelName, role: ClientRole.Broadcaster, callType: widget.callType);
...

                {
                  ...
                  return Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("is Busy", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                ...
                //       break;
                  ...
                  return Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("is Not-answering", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                ...
                //call end
                  ...
                  return Container(
                    ...
                    child: Text("Call Ended...".toString()),
