    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          "Phone number settings".toString(),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text("Phone number".toString(), style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            ...
            Card(
              ...
              title: Text(currentUser.phoneNumber != null ? "${currentUser.phoneNumber}" : "Verify Phone number".toString(),
            ...
            Padding(
              ...
              child: Text("Verified phone number".toString(),
                ...
                child: InkWell(
                  ...
                  child: Card(
                    ...
                    child: Padding(
                      ...
                      child: Text("Update my phone number".toString(),
